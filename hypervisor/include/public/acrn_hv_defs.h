...
/* New hypercalls */
#define HC_MASTER_GRANT				BASE_HC_ID(HC_ID, HC_ID_GEN_BASE + 0x04UL)
#define HC_MASTER_REVOKE			BASE_HC_ID(HC_ID, HC_ID_GEN_BASE + 0x05UL)
#define HC_SLAVE_REGISTER			BASE_HC_ID(HC_ID, HC_ID_GEN_BASE + 0x06UL)
#define HC_SLAVE_ACCEPT				BASE_HC_ID(HC_ID, HC_ID_GEN_BASE + 0x07UL)
